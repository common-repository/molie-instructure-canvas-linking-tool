				...
				if(wp_verify_nonce($_POST['molie-link-nonce'], "molie-link"))
				{
					...
					if($data){
						...
						if(count($data->content)!=0){
							...
							echo "<p>" . __("No course modules found, suggest checking or trying another course") . "</p>";
							echo "<p><a href='" . admin_url("edit.php?post_type=linkedcanvascourse") . "'>" . __("Click here to go to somewhere you can remove this course if it is an error") . "</p>";
							echo "<p><a href='" . admin_url("edit.php?post_type=linkedcanvascourse") . "'>" . __("Try linking another course") . "</p>";
						}
					}
					$loader->unregister();
				}
